...
public class Demo1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            //创建文件对象(关联xml文件)
            File file =
                    new File("D:\\北大青鸟学习\\Java-U1\\day_ch27 xml解析\\Codes\\Demo_day27\\src\\Demo\\stulist.xml");
            ...
            //4.读取xml文档的内容
            //4.1获取元素的所有子元素
            System.out.println("获取元素名称：" + root.getName());
            System.out.println("获取元素内容：" + root.getText());
            //4.2获取元素的所有子元素
            ...
            for (Attribute a:attributes) {
                System.out.println(a.getName());  //获取属性名称
                System.out.println(a.getValue()); //获取属性值
            }*/
            }

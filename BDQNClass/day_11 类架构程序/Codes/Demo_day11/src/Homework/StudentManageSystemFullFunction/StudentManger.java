...
public class StudentManger {
    ...
    public void mainMenu(){
        ...
        switch (tmp){
            case 1:
                ...
                break;
            case 2:
                this.secondMenuSerchStudent();
                break;
            case 3:
                this.secondMenuDeleteStudent();
                break;
            case 4:
                this.secondMenualterInfo();
                break;
            case 5:
                //退出
                System.exit(1);
    ...
    //二级菜单：查询学生
    public void secondMenuSerchStudent(){
    ...
    public void searchStudentByName(){
        ...
        for (int i = 0; i < count; i++) {
            ...
            /*if (student != null && student.name.equals(name)){  //null表示空   解决空指针问题
                System.out.println("学号：" + student.id + "\t姓名：" + student.name + "\t年龄：" + student.age +
                        "\t在读状态：" + (student.state == 0 ? "在读":"休学"));
                break;
            }else if (student == null){
                if (i == 0){    //代表第一个对象student就为空
                    System.out.println("未录入任何信息！请录入以后再重新输入！");
                    this.mainMenu();
                }else if(i != 0){   //对象student为空，但表中有信息时
                    System.out.println("未查找到学生信息，可能姓名输入错误！");
                    this.secondMenu();
                }
            }*/
            if (student != null){  //null表示空   解决空指针问题
                if (pos != -1){
                    System.out.println("学号：" + student.id + "\t姓名：" + student.name + "\t年龄：" + student.age +
                            "\t在读状态：" + (student.state == 0 ? "在读":"休学"));
                }
    ...
    //删除学生
    public void secondMenuDeleteStudent() {
    ...
    //二级菜单：修改学生信息菜单
    public void secondMenualterInfo(){
